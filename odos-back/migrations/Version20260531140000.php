...
final class Version20260531140000 extends AbstractMigration
{
    ...
    {
        return 'Réinitialisation mot de passe : token hashé + expiration sur user';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_USER_PASSWORD_RESET_TOKEN ON "user" (password_reset_token_hash)');
    }
