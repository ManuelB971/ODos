...
final class Version20260620130000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE content_report ADD CONSTRAINT FK_CONTENT_REPORT_COMMENT FOREIGN KEY (comment_id) REFERENCES comment (id) ON DELETE SET NULL NOT DEFERRABLE INITIALLY IMMEDIATE');
